  ...
  foreach(_tuple ${_exported_typesupport_libraries})
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      if(NOT _lib)
        ...
        message(FATAL_ERROR
          "Package 'turtle_interfaces' exports the typesupport library '${_library}' which couldn't be found")
      elseif(NOT IS_ABSOLUTE "${_lib}")
        # the found library must be an absolute path
        message(FATAL_ERROR
          "Package 'turtle_interfaces' found the typesupport library '${_library}' at '${_lib}' "
