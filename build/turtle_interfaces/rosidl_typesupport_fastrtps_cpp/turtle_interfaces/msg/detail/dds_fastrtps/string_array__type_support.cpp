...
#include "turtle_interfaces/msg/detail/string_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::StringArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::StringArray & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::msg::StringArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::StringArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::StringArray *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_StringArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, StringArray)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_StringArray__handle;
}
