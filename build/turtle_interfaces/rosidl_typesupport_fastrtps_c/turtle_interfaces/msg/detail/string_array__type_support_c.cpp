...
#include "turtle_interfaces/msg/detail/string_array__rosidl_typesupport_fastrtps_c.h"
...
using _StringArray__ros_msg_type = turtle_interfaces__msg__StringArray;
...
size_t get_serialized_size_turtle_interfaces__msg__StringArray(
  const void * untyped_ros_message,
...
static uint32_t _StringArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__StringArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__StringArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces__msg__StringArray;
    is_plain =
      (
...
static size_t _StringArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__msg__StringArray(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, StringArray)() {
